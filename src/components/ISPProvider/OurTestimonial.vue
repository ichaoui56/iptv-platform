<template>
  <div class="testimonial-area bg-gray5 ptb-100 position-relative z-1">
    <div class="container">
      <div
    ...
    <div class="container-fluid p-md-0 overflow-hidden">
      <Swiper
        :slidesPerView="1"
        :spaceBetween="50"
        ...
        :modules="modules"
        class="testomonial-slide"
      >
        <SwiperSlide v-for="testimonial in testimonials" :key="testimonial.id">
          <div :class="['testimonial-single-item', testimonial.className]">
      ...
      <div
        class="d-flex justify-content-between align-items-center google-review flex-wrap"
        data-aos="fade-up"
        data-aos-duration="1000"
        data-aos-delay="300"
      >
        ...
        <RouterLink to="/" class="read-more text-grey-teal">
    ...
    <img src="@/assets/images/shape-2.png" class="shape shape-2" alt="shape" />
  </div>
</template>
