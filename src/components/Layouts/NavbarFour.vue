<template>
  <nav :class="['navbar navbar-expand-lg bg-white p-0', { sticky: isSticky }]">
    <div :class="['position-relative', className]">
      <RouterLink class="navbar-brand" to="/">
        <img
          src="@/assets/images/logo.svg"
          class="main-logo d-none"
          alt="white-logo"
        />
        <img
      ...
      >
        ...
        <li class="d-none d-xl-block">
          <RouterLink to="/pricing-plan" class="btn">
            <span class="border-style">Get Subscription</span>
          </RouterLink>
        </li>
      </ul>
    </div>
